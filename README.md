...
4. Centralizing all data in a easily accessible database
**Key Features and Functionality**
1. For Transport Volunteers
 a. View and select available rides
 b. Access client pick-up and drop-off information
 c. Mark rides as completed, including one-way or round-trip status
 d. Track personal volunteer hours automatically
2. For Employees
 a. Input new rides into the system
 b. Assign clients to rides when necessary
 c. Manage volunteer information and schedules
 d. Access comprehensive reports on ride completion and volunteer hours
3. For Administrators
 a. Oversee employee accounts and permissions
 b. Monitor overall system performance
 c. Generate high-level reports on program effectiveness
4. For Clients (Indirect Users)
 a. While not directly using the app, client information and ride requests will be managed within the system
