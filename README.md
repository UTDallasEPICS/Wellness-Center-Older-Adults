...
`python3 consolidator.py ./ ./consolidated.txt -xd public .git .next node_modules migrations -xf mydb.db favicon.ico package-lock.json README.md consolidator.py consolidated.txt `
