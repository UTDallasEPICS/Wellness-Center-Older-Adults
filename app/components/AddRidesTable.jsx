...
const AddRidesTable = ({
  ...
  const handleEditFormSubmit = (event) => {
    ...
    if (
      editFormData.customerName !== currentCustomerName ||
      editFormData.phoneNumber !== currentCustomerPhone
    ) {
      const [firstName, ...lastNameParts] =
        editFormData.customerName.split(" ");
      customerUpdates = {
    ...
    if (
      editFormData.startAddress &&
      editFormData.startAddress !== originalContact.startLocation
    ) {
      const addressParts = editFormData.startAddress
        .split(",")
        .map((part) => part.trim());
    ...
    const currentVolunteerName = getVolunteerNameById(
      originalContact.volunteerID
    );
    if (
      editFormData.volunteerName &&
      editFormData.volunteerName !== currentVolunteerName
    ) {
