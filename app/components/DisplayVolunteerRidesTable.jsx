...
import VolunteerViewOnlyRow from "./VolunteerViewOnlyRow";

const DisplayVolunteerRidesTable = ({ initialContacts }) => {
  {
...
export default DisplayVolunteerRidesTable;
